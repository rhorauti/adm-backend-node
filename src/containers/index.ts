...
// container.registerSingleton(TOKENS.AddressRepository, AddressRepository);
...
// container.registerSingleton(TOKENS.TaskTypeRepository, TaskTypeRepository);
container.registerSingleton(TOKENS.TaskTypeController, TaskTypeController);
// container.registerSingleton(TOKENS.DepartmentRepository, DepartmentRepository);
...
// container.registerSingleton(TOKENS.ProductionLineRepository, ProductionLineRepository);
container.registerSingleton(TOKENS.ProductTypeController, ProductTypeController);
// container.registerSingleton(TOKENS.ProductTypeRepository, ProductTypeRepository);
...
// container.registerSingleton(TOKENS.UnitRepository, UnitRepository);
