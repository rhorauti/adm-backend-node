...
export class InitMigration1755802928727 implements MigrationInterface {
    name = 'InitMigration1755802928727'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Kpi" ("idKpi" SERIAL NOT NULL, "goal" character varying, "operator" character varying(2), "metric" double precision, "unit" character varying(5), "comment" character varying, "idDepartment" integer, CONSTRAINT "PK_kpi" PRIMARY KEY ("idKpi"))`);
        ...
        await queryRunner.query(`CREATE TABLE "EmployeePosition" ("idEmployeePosition" SERIAL NOT NULL, "name" character varying, "comment" character varying, CONSTRAINT "UQ_employee_position_name" UNIQUE ("name"), CONSTRAINT "PK_employee_position" PRIMARY KEY ("idEmployeePosition"))`);
        await queryRunner.query(`CREATE TABLE "Task" ("id" SERIAL NOT NULL, "startTime" TIMESTAMP NOT NULL DEFAULT now(), "pauseTime" TIMESTAMP, "finishTime" TIMESTAMP, "type" character varying, "task" character varying, "status" character varying, "comment" character varying, "idEmployee" integer, CONSTRAINT "PK_maintenance_task" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Employee" ("idEmployee" SERIAL NOT NULL, "isDefault" boolean NOT NULL, "name" character varying, "cpf" character varying(14), "email" character varying, "deskphone" character varying(20), "photoUrl" character varying, "cellphone" character varying(20), "idCompany" integer, "idDepartment" integer, "idEmployeePosition" integer, CONSTRAINT "UQ_employee_cpf" UNIQUE ("cpf"), CONSTRAINT "REL_4f630298fc5cc22d7df9411e75" UNIQUE ("idEmployeePosition"), CONSTRAINT "PK_employee" PRIMARY KEY ("idEmployee"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Product" ("idProduct" SERIAL NOT NULL, "name" character varying NOT NULL, "stock" integer, "comment" integer, "idProject" integer, CONSTRAINT "PK_product" PRIMARY KEY ("idProduct"))`);
        await queryRunner.query(`CREATE TABLE "ProductionLine" ("idProductionLine" SERIAL NOT NULL, "lineCode" character varying, "lineName" character varying, "comment" character varying, CONSTRAINT "UQ_production_line_code" UNIQUE ("lineCode"), CONSTRAINT "PK_production_line" PRIMARY KEY ("idProductionLine"))`);
        await queryRunner.query(`CREATE TABLE "Asset" ("idAsset" SERIAL NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "comment" character varying, "idProduct" integer, "idProject" integer, "idCompany" integer, "idProductionLine" integer, CONSTRAINT "PK_asset" PRIMARY KEY ("idAsset"))`);
        ...
        await queryRunner.query(`CREATE TABLE "PurchasingOrder" ("idPurchasingOrder" SERIAL NOT NULL, "productQty" double precision, "paymentCondition" character varying(30), "idCompany" integer, CONSTRAINT "PK_purchasing_order" PRIMARY KEY ("idPurchasingOrder"))`);
        await queryRunner.query(`CREATE TABLE "Company" ("idCompany" SERIAL NOT NULL, "nickname" character varying(50), "name" character varying(100), "cnpj" character varying(20), "ie" character varying(50), "im" character varying(50), CONSTRAINT "UQ_company_im" UNIQUE ("im"), CONSTRAINT "UQ_company_ie" UNIQUE ("ie"), CONSTRAINT "UQ_company_cnpj" UNIQUE ("cnpj"), CONSTRAINT "UQ_company_name" UNIQUE ("name"), CONSTRAINT "UQ_company_nickname" UNIQUE ("nickname"), CONSTRAINT "PK_company" PRIMARY KEY ("idCompany"))`);
        await queryRunner.query(`CREATE TABLE "Production" ("idProduction" SERIAL NOT NULL, "lineCode" character varying(20), "lineName" character varying(30), "productQtyPlan" double precision, "productQtyActual" double precision, CONSTRAINT "PK_production" PRIMARY KEY ("idProduction"))`);
        await queryRunner.query(`ALTER TABLE "EmployeeContract" ADD CONSTRAINT "FK_employee_contract_employee" FOREIGN KEY ("idEmployee") REFERENCES "Employee"("idEmployee") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "EmployeeVacation" ADD CONSTRAINT "FK_employee_vacation_employee" FOREIGN KEY ("idEmployee") REFERENCES "Employee"("idEmployee") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Task" ADD CONSTRAINT "FK_maintenance_task_employee" FOREIGN KEY ("idEmployee") REFERENCES "Employee"("idEmployee") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Employee" ADD CONSTRAINT "FK_employee_department" FOREIGN KEY ("idDepartment") REFERENCES "Department"("idDepartment") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ProjectEvent" ADD CONSTRAINT "FK_project_event_project" FOREIGN KEY ("idProject") REFERENCES "Project"("idProject") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Product" ADD CONSTRAINT "FK_product_project" FOREIGN KEY ("idProject") REFERENCES "Project"("idProject") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Asset" ADD CONSTRAINT "FK_asset_product" FOREIGN KEY ("idProduct") REFERENCES "Product"("idProduct") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Asset" ADD CONSTRAINT "FK_asset_company" FOREIGN KEY ("idCompany") REFERENCES "Company"("idCompany") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Asset" ADD CONSTRAINT "FK_asset_production_line" FOREIGN KEY ("idProductionLine") REFERENCES "ProductionLine"("idProductionLine") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Invoice" ADD CONSTRAINT "FR_invoice_company" FOREIGN KEY ("idCompany") REFERENCES "Company"("idCompany") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "PurchasingOrder" ADD CONSTRAINT "FK_purchasing_order_company" FOREIGN KEY ("idCompany") REFERENCES "Company"("idCompany") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Asset" DROP CONSTRAINT "FK_asset_product"`);
        await queryRunner.query(`ALTER TABLE "Product" DROP CONSTRAINT "FK_product_project"`);
        ...
        await queryRunner.query(`ALTER TABLE "EmployeeVacation" DROP CONSTRAINT "FK_employee_vacation_employee"`);
