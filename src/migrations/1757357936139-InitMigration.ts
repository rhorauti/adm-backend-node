...
export class InitMigration1757357936139 implements MigrationInterface {
    name = 'InitMigration1757357936139'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ProductionLine" ("idProductionLine" SERIAL NOT NULL, "lineCode" character varying NOT NULL, "lineName" character varying, "comment" character varying, CONSTRAINT "UQ_production_line_code" UNIQUE ("lineCode"), CONSTRAINT "PK_production_line" PRIMARY KEY ("idProductionLine"))`);
        ...
        await queryRunner.query(`CREATE TABLE "EmployeePosition" ("idEmployeePosition" SERIAL NOT NULL, "name" character varying NOT NULL, "comment" character varying, CONSTRAINT "UQ_employee_name" UNIQUE ("name"), CONSTRAINT "PK_employee_position" PRIMARY KEY ("idEmployeePosition"))`);
        ...
        await queryRunner.query(`ALTER TABLE "TaskType" ADD CONSTRAINT "FK_task_type_department" FOREIGN KEY ("idDepartment") REFERENCES "Department"("idDepartment") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Product" ADD CONSTRAINT "FK_asset_project" FOREIGN KEY ("idProject") REFERENCES "Project"("idProject") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Task" ADD CONSTRAINT "FK_task_employee" FOREIGN KEY ("idEmployee") REFERENCES "Employee"("idEmployee") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Task" ADD CONSTRAINT "FK_task_task_type" FOREIGN KEY ("idTaskType") REFERENCES "TaskType"("idTaskType") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Task" ADD CONSTRAINT "FK_task_kpi" FOREIGN KEY ("idKpi") REFERENCES "Kpi"("idKpi") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Employee" ADD CONSTRAINT "FK_employee_employee_position" FOREIGN KEY ("idEmployeePosition") REFERENCES "EmployeePosition"("idEmployeePosition") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Invoice" ADD CONSTRAINT "FR_invoice_purchasing_order" FOREIGN KEY ("idPurchasingOrder") REFERENCES "PurchasingOrder"("idPurchasingOrder") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Invoice" DROP CONSTRAINT "FR_invoice_purchasing_order"`);
        ...
        await queryRunner.query(`ALTER TABLE "Task" DROP CONSTRAINT "FK_task_kpi"`);
        await queryRunner.query(`ALTER TABLE "Task" DROP CONSTRAINT "FK_task_task_type"`);
        await queryRunner.query(`ALTER TABLE "Task" DROP CONSTRAINT "FK_task_employee"`);
        await queryRunner.query(`ALTER TABLE "Product" DROP CONSTRAINT "FK_asset_project"`);
        await queryRunner.query(`ALTER TABLE "ProjectEvent" DROP CONSTRAINT "FK_project_event_project"`);
        await queryRunner.query(`ALTER TABLE "TaskType" DROP CONSTRAINT "FK_task_type_department"`);
        ...
        await queryRunner.query(`DROP TABLE "TaskType"`);
